...
type            = ChangeState
value      = 54
triggerall      = (command = "superj")
triggerall      = (!statetype = A)
trigger1	= (stateno = 702) && MoveHit
;---------------------------------------------------------------------------
;Run Fwd AIR
[State -1: 		Run Fwd]
type 			= ChangeState
...
;---------------------------------------------------------------------------
; kameha final
[State -1, kameha final]
type = ChangeState
value = 4000
triggerall = command = "kameha final"
trigger1 = (statetype = S) && ctrl
...
type = ChangeState
value = 2070
triggerall = (command="Chou KHH")&&power>=2000
trigger1 = roundstate=2
trigger1 = statetype!=A&&ctrl
trigger2 =  stateno=200&& movecontact
trigger3 =  stateno=213&& movecontact
...
type = ChangeState
value = 755
triggerall = command ="Ki_Missle_X"
trigger1 = statetype!=A&&ctrl
trigger2 =  stateno=200&& movecontact
trigger3 =  stateno=213&& movecontact
trigger4 =  stateno=210&& movecontact
...
type = ChangeState
value = 756
triggerall = command ="Ki_Missle_Y"
trigger1 = statetype!=A&&ctrl
trigger2 =  stateno=200&& movecontact
trigger3 =  stateno=213&& movecontact
trigger4 =  stateno=210&& movecontact
...
trigger4 = command = "AI13" || command = "AI14" || command = "AI15"
var(59) = 1
