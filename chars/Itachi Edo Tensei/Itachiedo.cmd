...
;---------------------------------------------------------------------------
;katon
[State -1, Katon : Goukakyo No Jutsu]
type = ChangeState
value = 260
...
;katon
[State -1, Suiton : Suyruddan No Jutsu]
type = ChangeState
value = 270
triggerall = power >= 2000
triggerall = command = "y"
...
;katon
[State -1, Katon : Hounseka No Jutsu Air]
type = ChangeState
value = 440
...
;katon
[State -1, Katon : Hosenka Tsumabeni No Jutsu]
type = ChangeState
value = 654
triggerall = power >= 1500
